...
class MaraHackathon():
    ...
    # Tasks - Order matters! Define independent tasks first, then dependent tasks
    ...
    # Phase 2: Strategic optimization (depends on Phase 1)
    @task
    ...
    # Phase 3: Carbon arbitrage (depends on optimization results)
    @task 
    ...
    # Phase 4: Dashboard publication (depends on all previous tasks)
    @task
